...
{
    int retenue = 0;
    char *str1 = negative_check_sub_s(my_strdup(argv1), my_strdup(argv2), 1);
    char *str2 = negative_check_sub_s(my_strdup(argv2), my_strdup(argv1), 2);
